<template>
  <footer class="footer">
    <div class="footer-top">
      <div class="container">
        <ul class="social-icons">
          <li>
            <a
              href="http://facebook.com/crandelldesign"
              target="_blank"
              title="Facebook"
          ...
          <li>
            <a
              href="https://github.com/crandelldesign"
              target="_blank"
              rel="publisher"
              title="GitHub"
            >
        ...
        <div class="footer-contact">
          <p>
            Phone: <a class="phone" href="tel:+12483835376">248-383-5376</a>
          </p>
          <p>
            Email:
    ...
    <div class="footer-bottom">
      <p>
        Copyright &copy; {{ new Date() | date('yyyy') }} Matt Crandell &amp;
        Crandell Design. All Rights Reserved.
      </p>
      <p>
